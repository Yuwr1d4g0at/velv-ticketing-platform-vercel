...
- Background jobs (SLA/warranty/contract/recurring/digest checks, nightly backups) run via **Vercel Cron** hitting `/api/cron/*`, plus an opportunistic in-request trigger during business hours — see `src/periodicChecks.js`
